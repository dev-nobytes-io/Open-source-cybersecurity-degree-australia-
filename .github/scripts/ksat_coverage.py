...
def main() -> int:
    ...
    out.append("> `### NICE/DCWF KSATs` tables. Do not edit by hand.")
    out.append(">")
    out.append("> **Nothing on this page is framework-verified.** The `<UNIT>-K/S/A` IDs are")
    out.append("> project-local self-descriptions. The official-looking `T####` codes are")
    out.append("> external DCWF identifiers, and their task statements were written per-unit")
    out.append("> rather than transcribed from the DCWF \u2014 29 codes currently carry divergent")
    out.append("> statements across 252 of 262 rows. Both are provisional pending Framework")
    out.append("> Custodian verification. See")
    out.append("> [`docs/review/framework-verification.md`](review/framework-verification.md)")
    out.append("> and [`docs/maturity-models.md`](maturity-models.md).")
    out.append("")
