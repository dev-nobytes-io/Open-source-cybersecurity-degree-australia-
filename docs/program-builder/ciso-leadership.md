# Program: Strategy + Leadership & CISO major
...
Shared core plus the six Leadership & CISO units.

**Selection:** 24 of 66 units · **235** KSAT items (93 K · 48 S · 48 A · 46 T) · **36%** of the full catalogue (655 items).
...
xychart-beta horizontal
  ...
  x-axis ["OV-EXL-001", "OV-SPP-002", "SP-DEV-001", "OV-MGT-001", "OM-ADM-001", "OV-SPP-001", "OV-LGA-001", "OV-LGA-002", "PR-CIR-001", "PR-VAM-001", "SP-RSK-002", "SP-ARC-001", "PR-CDA-001", "AN-EXP-001", "AN-TWA-001", "AN-ASA-001", "IN-FOR-002", "SP-ARC-002", "IN-INV-001", "SP-DEV-002"]
  y-axis "Percent complete" 0 --> 100
  bar [100, 100, 100, 75, 66, 56, 50, 50, 50, 50, 50, 33, 23, 20, 20, 14, 14, 14, 0, 0]
```
...
| Information Systems Security Manager | OV-MGT-001 | 88 | 118 | 75% |
| System Administrator | OM-ADM-001 | 19 | 29 | 66% |
| Cyber Policy & Strategy Planner | OV-SPP-001 | 50 | 90 | 56% |
...
| Cyber Defense Analyst | PR-CDA-001 | 57 | 247 | 23% |
...
radar-beta
  ...
  curve sel["Selected"]{21, 24, 24, 0, 0, 0, 0, 0, 0, 24, 0}
  max 24
  min 0
```
...
radar-beta
  ...
  curve sel["Selected"]{12, 12, 12, 0, 0, 0, 0, 0, 0, 12, 0}
  max 12
  min 0
```
...
radar-beta
  ...
  curve sel["Selected"]{12, 12, 12, 0, 0, 0, 0, 0, 0, 10, 0}
  max 12
  min 0
```
...
```mermaid
flowchart LR
  P([Strategy + Leadership & CISO major])
