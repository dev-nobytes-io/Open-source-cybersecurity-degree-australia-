# Program: Operations + Detection Engineering major
...
Shared core plus the six Detection Engineering units.
...
| Detection Engineering | DE01, DE02, DE03, DE04, DE05, DE06 |
...
xychart-beta horizontal
  ...
  x-axis ["SP-DEV-001", "OM-ADM-001", "OV-LGA-001", "OV-LGA-002", "PR-CIR-001", "PR-VAM-001", "SP-RSK-002", "PR-CDA-001", "OV-SPP-001", "SP-ARC-001", "OV-MGT-001", "AN-EXP-001", "AN-TWA-001", "AN-ASA-001", "IN-FOR-002", "SP-ARC-002", "IN-INV-001", "OV-EXL-001", "OV-SPP-002", "SP-DEV-002"]
  y-axis "Percent complete" 0 --> 100
  bar [100, 66, 50, 50, 50, 50, 50, 47, 44, 33, 25, 20, 20, 14, 14, 14, 0, 0, 0, 0]
```
...
radar-beta
  ...
  curve sel["Selected"]{21, 24, 24, 0, 0, 0, 24, 0, 0, 0, 0}
  max 24
  min 0
```
...
radar-beta
  ...
  curve sel["Selected"]{12, 12, 12, 0, 0, 0, 12, 0, 0, 0, 0}
  max 12
  min 0
```
...
| Detection Engineering | 24 / 24 | 12 / 12 | 12 / 12 | 12 / 12 |
