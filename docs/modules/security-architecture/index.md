...
| [SA-05](sa-05-logging-and-monitoring-architecture.md) | Logging, Monitoring and Detection Architecture | NIST SP 800-92; ASD *Priority logs for SIEM ingestion*, *Best practices for event logging and threat detection*, *Windows event logging and forwarding*, *Implementing SIEM and SOAR platforms*; CREST *Cyber Security Monitoring Guide*; one vendor reference-architecture example; Splunk Validated Architectures (one vendor reference set, taught as a worked example) | ~24 |
