...
- [ ] Phase 3 — All major unit content written (8 majors × 6 units = 48 unit files) _(in progress: TH, DFIR, CTI, DE, Leadership drafted (30 units); CTE, Security Engineering, GRC remaining)_
