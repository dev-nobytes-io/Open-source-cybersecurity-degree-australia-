...
```mermaid
graph LR
    SE_MAJ["Security Engineering Major"] --> R1["Security Architect"]
    SE_MAJ --> R2["Security Engineer"]
    SE_MAJ --> R3["Principal Security Consultant"]
    SE_MAJ --> R4["Cloud Security Architect"]
```
