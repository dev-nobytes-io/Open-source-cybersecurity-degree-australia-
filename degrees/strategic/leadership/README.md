...
```mermaid
graph LR
    LD_MAJ["Leadership Major"] --> R1["CISO"]
    LD_MAJ --> R2["Security Director"]
    LD_MAJ --> R3["VP / Head of Security"]
    LD_MAJ --> R4["Security Program Manager"]
```
...
mindmap
  root((Australian CISO Context))
    ...
    Reporting Obligations
      ...
      APRA notification (72hr)
      ASD voluntary reporting
      OAIC NDB notification
    Stakeholder Landscape
      ASX-listed company obligations
      Relationship with ASD/ACSC
      Engagement with AFP Cybercrime
      CERT Australia coordination
    Industry Bodies
      AISA (Aust Info Sec Assoc)
      ACS (Aust Computer Society)
      ISACA AU chapter
```
